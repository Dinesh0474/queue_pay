...
export default function Page() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await axios.post("https://queue-server-pe7n.onrender.com"+`/api/shopsuser/getorder`, { id });
  ...
  setInterval(async () => {
    ...
    const res= await axios.post("https://queue-server-pe7n.onrender.com"+"/api/orders/generatejwt",{orderId:id,shopId:orderData.shop.shop_id,userId:userid});
